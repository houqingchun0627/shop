...
<div id="header-div">
    ...
    <div id="submenu-div">
        <ul>
            <li><a href="<?php echo U('Home/Goods/index');?>" target="_blank">前台首页</a></li>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?php echo U('Admin/index');?>" target="main-frame">起始页</a></li>
        <li><a href="<?php echo U('Goods/goodsMessage');?>" target="main-frame">商品列表</a></li>
        <li><a href="<?php echo U('Order/orderMessage');?>" target="main-frame">订单列表</a></li>
        <li><a href="<?php echo U('User/userComment');?>" target="main-frame">用户评论</a></li>
        <li><a href="<?php echo U('User/userMessage');?>" target="main-frame">会员列表</a></li>
        <li class="fix-spacer">&nbsp;</li>
        <li style="margin:0px 30px;color:red;font-weight: bold;">欢迎你，<?php echo (session('admin_name')); ?></li>
    </ul>
    <br class="clear" />
</div>
</body>

...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('brandHandler',array('id' => 1));?>">添加品牌</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($brandList)): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><img src="<?php if($vo[is_promote] == 是): ?>/shop/Public/Admin/Images/yes.gif <?php else: ?> /shop/Public/Admin/Images/no.gif<?php endif; ?>"/></td>
                <td align="center">
                <a href="" target="_blank" title="查看"><img src="/shop/Public/Admin/Images/icon_view.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U('brandHandler',array('id' => 2,'brand_id' => $vo['brand_id']));?>" title="编辑"><img src="/shop/Public/Admin/Images/icon_edit.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U('brandHandler',array('id' => 3,'brand_id' => $vo['brand_id']));?>" title="删除" onclick="return confirm('你确定要删除吗？');"><img src="/shop/Public/Admin/Images/icon_drop.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U('brandHandler',array('id' => 4,'brand_id' => $vo['brand_id']));?>" onclick="" title="回收站"><img src="/shop/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a></td>

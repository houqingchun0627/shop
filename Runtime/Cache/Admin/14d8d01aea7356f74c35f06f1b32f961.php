...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U('authMessage',array('id' => 1));?>">添加权限</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($authList)): $i = 0; $__LIST__ = $authList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="left"><?php echo str_repeat('&nbsp;',8*$vo['level']); echo ($vo["auth_name"]); ?></td>
                    <!-- 权限上级权限显示时，利用联表查询，显示权限名称，而不是权限auth_id -->
                    <td align="center"><?php echo ($vo["auth_parent"]); ?></td>
                    ...
                    <td align="center"><?php echo ($vo["auth_controller"]); ?></td>
                    <td align="center"><?php echo ($vo["auth_action"]); ?></td>
                    <td align="center"><?php echo ($vo["auth_path"]); ?></td>
                    <td align="center"><?php echo ($vo["auth_level"]); ?></td>
                    <td align="center" width="25%"><?php echo ($vo["auth_desc"]); ?></td>
                    ...
                    <a href="<?php echo U('authMessage',array('id' => 2,'auth_id' => $vo['auth_id']));?>" title="编辑"><img src="/shop/Public/Admin/Images/icon_edit.gif" width="16" height="16" border="0" /></a>
                    <a href="<?php echo U('authMessage',array('id' => 3,'auth_id' => $vo['auth_id']));?>" title="删除" onclick="return confirm('你确定要删除吗？');"><img src="/shop/Public/Admin/Images/icon_drop.gif" width="16" height="16" border="0" /></a>
                    <a href="<?php echo U('authMessage',array('id' => 4,'auth_id' => $vo['auth_id']));?>" onclick="" title="回收站"><img src="/shop/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
